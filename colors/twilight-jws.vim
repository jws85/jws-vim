" This is an edit of the 'twilight' color scheme that fixes some of
" the coloring to my preferences.
"
" The 'twilight' color scheme seems to be originally from TextMate,
" so I guess thanks to them for a really nice, relaxing color scheme.
...
if version >= 700
  ...
  hi Pmenu guifg=#cbbbba guibg=#303030
  hi PmenuSel guifg=#cec5c3 guibg=#404040 gui=italic
  "PmenuSbar
  "PmenuThumb
endif
...
exe 'hi TODO           guifg='.s:grey_blue         .' guibg='.s:darkgrey        .' gui=italic'
